        ...
        PreparedStatement pstmt = null;
            try {
                ...
                while (resultSet.next()) {
                    ...
                    out.println("<td>" + resultSet.getString("medname") + "</td>");
                    out.println("<td>" + resultSet.getDouble("price") + "</td>");
                    out.println("<td>" + resultSet.getDate("manudate") + "</td>");
                    out.println("<td>" + resultSet.getDate("expdate") + "</td>");
                    out.println("<td>" + resultSet.getString("company") + "</td>");
                    out.println("</tr>");
                }
